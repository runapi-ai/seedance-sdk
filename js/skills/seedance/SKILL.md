...
- For a one-off artifact or result, use the registered `seedance` service in the `runapi` CLI. If the installed command catalog does not list it, stop and report the missing service instead of inventing a command.
...
runapi seedance <operation> --help
curl --fail --location https://runapi.ai/docs/api/seedance/<operation>.md --output contract.md
```
...
```shell
runapi seedance <operation> --async --input-file request.json > task.json
...
```shell
runapi wait "$task_id" --service seedance --action <operation> > result.json
```
...
- SDK integration: https://github.com/runapi-ai/seedance-sdk

## Variants
- `seedance-1.5-pro`: https://runapi.ai/models/seedance/1.5-pro.md
- `seedance-2-mini`: https://runapi.ai/models/seedance/2-mini.md
- `seedance-2.0`: https://runapi.ai/models/seedance/2.0.md
- `seedance-2.0-fast`: https://runapi.ai/models/seedance/2.0-fast.md
- `seedance-2.5`: https://runapi.ai/models/seedance/2.5.md
- `seedance-v1-pro`: https://runapi.ai/models/seedance/v1-pro.md
- `seedance-v1-pro-fast`: https://runapi.ai/models/seedance/v1-pro-fast.md
